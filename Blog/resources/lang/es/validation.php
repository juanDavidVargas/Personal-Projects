...
return [
	...
	*/
	...
	"min"                  => [
		"numeric" => "El campo :attribute debe ser :min o superior.",
		"file"    => "El campo :attribute debe tener :min kilobytes o más.",
		"string"  => "El campo :attribute debe tener :min caracteres o más.",
		"array"   => "El campo :attribute debe tener :min ítems o más.",
	],
