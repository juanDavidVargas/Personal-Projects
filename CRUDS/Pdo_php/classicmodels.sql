...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-03-2017 a las 02:52:34
...
INSERT INTO `orders` (`orderNumber`, `orderDate`, `requiredDate`, `shippedDate`, `states`, `comments`, `customerNumber`) VALUES
...
--
-- Estructura de tabla para la tabla `products_2`
--
...
--
-- Volcado de datos para la tabla `products_2`
--

INSERT INTO `products_2` (`id`, `nombre`, `precio`, `descripcion`) VALUES
(1, 'Televisor', '7500', 'Pantalla 40 pulgadas'),
(2, 'PC', '15600', 'Gaming PC');
...
(1, 'ABC Inc', '408-908-2476', '4000 North 1st Street, San Jose CA, USA');
...
--
-- Indices de la tabla `products_2`
--
...
ALTER TABLE `proveedores`
  ...
  ADD UNIQUE KEY `uc_nombre_direccion` (`nombre`,`direccion`);
...
--
-- AUTO_INCREMENT de la tabla `products_2`
--
ALTER TABLE `products_2`
