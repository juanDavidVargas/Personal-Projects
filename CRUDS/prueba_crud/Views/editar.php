   ...
   <body>
      ...
      <div class="row-fluid">
        <div class="container">
          ...
          <div class="col-md-6">
            <hr>
            <a href="Listado.php"><button type="button" name="button" class="btn btn-info">Ir a listado </button></a>
            <hr>
            <form class="form-horizontal" action="../Logica/update.php" method="post">
